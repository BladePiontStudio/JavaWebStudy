    ...
    <div class="lyear-layout-container">
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-header"><h4>新增图书</h4></div>
                        <div class="card-body">

                            <form class="form-horizontal" action="${initParam.ProjectDir}/manager/book?action=add"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12">
                                        <input class="form-control" type="text" id="sales"
